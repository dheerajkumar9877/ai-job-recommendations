        ...
        <header className="bg-white border-b border-slate-200 px-6 md:px-10 py-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="w-10 h-10 rounded-lg border border-slate-300 flex items-center justify-center text-slate-600 hover:bg-slate-100 transition shrink-0"
              aria-label="Go back"
            >
              ←
            </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 rounded-lg border border-slate-300 text-slate-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    >
                      <option value="">
                        Select job type
                      </option>
            ...
            <section className="bg-white rounded-2xl border border-slate-200 shadow-sm mb-6">
              ...
              <div className="p-6 md:p-8">
                ...
                <textarea
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg border border-slate-300 text-slate-900 outline-none resize-none placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                />
...
• Understanding of REST APIs`}
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 pb-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-7 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition disabled:bg-blue-300 disabled:cursor-not-allowed shadow-sm"
              >
